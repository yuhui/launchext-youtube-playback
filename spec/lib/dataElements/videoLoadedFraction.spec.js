...
describe('videoLoadedFraction data element delegate', function() {
  var dataElementDelegate = require('../../../src/lib/dataElements/videoLoadedFraction');
  ...
  describe('with invalid "event" argument', function() {
    ...
    it(
      ...
      function() {
        delete this.event.youtube.videoLoadedFraction;
        var result = dataElementDelegate(this.settings, this.event);
        expect(result).toBeUndefined();
      }
    );
